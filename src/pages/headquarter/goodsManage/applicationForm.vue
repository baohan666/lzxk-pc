<template>
	<div>
		   ...
		   <el-form  :inline="true" class="demo-form-inline">
			    ...
			    <div class="div-inline el-form-item">
			 		<depart-componet departMsg= "" @selectSuccess = "selectSuccess"></depart-componet>
			 	</div>
			  	<el-form-item>
		...
		<div class="table_wrap">
			<el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark">
			    ...
			    <el-table-column prop="applicationProvince" label="申请省区" width="120"></el-table-column>
			  	<el-table-column prop="provinceManager" label="省区经理" width="120"></el-table-column>
			    <el-table-column prop="changeArea" label="改价区域"></el-table-column>
...
<script>
	...
	import {getApplyChaPricData, exportApplyChaPriData, getCheckStatusData, } from 'src/api/headquarter_url/goodsManage';
export default {
    data() {
      	return {
      		goodsName: ''  //商品名称
    ...
    components:{
 	...
 	methods: {
		...
		toCheckview($id){
			this.$router.push({"path":"applyFormDeataiZB", query:{"applyId": $id}})
		},
		//点击分页
			updataPage(val){
