		...
		<div id="" v-show="!handleDetailShow">
			<div class="search_wrap">
				...
				<el-form :inline="true" class="demo-form-inline">
					...
					<el-form-item label="产品名称：">
						...
						<el-select v-model="oweStatus" placeholder="请选择状态">
							<el-option label="请选择状态" value='' style='color：#B9BDC6'></el-option>
				...
				<el-table v-if="oweType==3" :data="tableData" border key='twoTable'>
					...
					<el-table-column prop="totalBox" label="盈余数量"  align='center'>
					</el-table-column>
				...
				<el-table v-if="oweType==4" :data="tableData" border key='lastTable'>
					...
					<el-table-column prop="date" label="操作" align='center' >
						<template slot-scope="scope">
							<div class="operateBtn"  @click="dialogVisible = true,oweStatus=scope.row.oweStatus,ordersOweId=scope.row.id" v-show='scope.row.oweStatusStr != "已处理" || scope.row.oweStatus != "9" '>待处理</div>
							<div class="operateBtn" @click="handleCheck(scope.$index, scope.row )">查看详情</div>
						</template>
					</el-table-column>
				</el-table>
