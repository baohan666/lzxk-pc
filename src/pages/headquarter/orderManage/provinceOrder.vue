		...
		<div id="" v-show="!handleEditShow">
			<div class="search_wrap">
				...
				<el-form ref="form" :inline="true" class="demo-form-inline slideDown">
					...
					<el-form-item label="销管：">
						<el-input v-model="saleManager" placeholder="请输入销管"></el-input>
					</el-form-item>
					...
					<el-form-item label="订单类型：">
						<el-select v-model="ordersFrom" placeholder="请选择订单类型">
						
							<el-option label="请选择订单类型" value=''></el-option>
							<el-option label="省总采购" value='5'></el-option>
							<el-option label="省办人员采购" value="10"></el-option>
						</el-select>
					</el-form-item>
					<div class="div-inline el-form-item">
			...
			<div class='table_wrap'>
				<el-table :data="tableData" border>
					...
					<el-table-column prop="from" label="订单类型" align='center'>
					</el-table-column>
					...
					<el-table-column prop="totalPrice" label="金额合计(元)" align='center'>
					</el-table-column>				
					<el-table-column prop="status" label="订单状态"  align='center'>
					</el-table-column>
					<el-table-column prop="saleManager" label="销管" align='center'>
					</el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			getData(pageIndex, pageSize, ordersNum, ordersFrom , submitName, departmentId, ordersStatus, provinceName, managerName,saleManager ,startCreateDate, endCreateDate, startModifyDate, endModifyDate) {
			...
			//查询
			searchQuery() {
				this.getData(1, this.pageSize, this.ordersNum, this.ordersFrom , this.submitName, this.departmentId, this.ordersStatus, this.provinceName, this.managerName, this.saleManager,this.startCreateDate, this.endCreateDate, this.startModifyDate, this.endModifyDate)
			...
			updataPage(val){ 
				...
				this.getData(this.pageIndex, this.pageSize, this.ordersNum, this.ordersFrom , this.submitName, this.departmentId, this.ordersStatus, this.provinceName, this.managerName, this.saleManager,this.startCreateDate, this.endCreateDate, this.startModifyDate, this.endModifyDate)
			},
			//点击事业部
			selectSuccess(val) {
			...
			handleCheck(index, row) {
				this.$router.push({path:'provinceOrderDetailZB',query:{id:row.id}});			
			}
