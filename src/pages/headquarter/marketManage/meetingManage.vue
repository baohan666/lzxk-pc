  ...
  <div>
    ...
    <div class="table_wrap">
      <el-table :data="tableData" border tooltip-effect="dark" >
        ...
        <el-table-column prop="provinceName" label="负责省区"></el-table-column> // 11111
        <el-table-column prop="managerName" label="省区经理"></el-table-column> // 11111
...
<script>
  ...
  import {getPromPolicyData, saveBanStatus} from 'src/api/headquarter_url/meetingManage';
  ...
  export default {
    ...
    methods: {
      ...
      view($id,$type){
        ...
        this.$router.push({path:'/meetingManageDetailZB',query:{id:$id,type:$type}});
      },
