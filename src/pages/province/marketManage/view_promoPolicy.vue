	...
	<div>
		...
		<div class="containInfo_wraper">
          ...
          <el-col v-if="goodsDetai.policyTypeCheck != null" :span="7"><div class="grid-content bg-purple">
            ...
            <div class="grid-content bg-purple">
              <span>核销期间</span>：{{goodsDetai.verificationStartDate}}--{{goodsDetai.verificationEndDate}}
            </div>
          </el-col>
				  <el-col :span="7"><div class="grid-content bg-purple"><span>政策说明</span>：{{goodsDetai.remark}}
          </div>
          </el-col>
				</el-row>
			</div>
		...
		<div class="containInfo_wraper">
			...
			<div class = "detail_table">
				...
				<releaseRange
          ref="dialogSeleProMa"
          :dialogRangeVisible="dialogRangeVisible"
          :relRangeList ="goodsDetai.rangeList"
          :isEdit="isEdit"
          :isView="true"
          title ="发布范围"
        >
...
<script>
  ...
  import {promoPolyDetail} from 'src/api/province_url/promotionPolicy';
