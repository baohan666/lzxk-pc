...
<style lang="scss">
	...
	#checkOutDialog .checkDeptProvince {
		width: 350px;
	}
	
	#checkOutDialog .checkDeptProvince .checkDeptList {
	...
	#checkOutDialog .checkDeptProvince .checkDeptTitle {
		margin-top: 20px;
	}
	
	#checkOutDialog .checkDeptProvince .checkDeptList img {
		float: right;
